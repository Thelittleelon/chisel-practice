error id: file://<WORKSPACE>/src/test/scala/passthrough_test_example.scala:`<none>`.
file://<WORKSPACE>/src/test/scala/passthrough_test_example.scala
...
non-local guesses:
	 ...
	 -scala/Predef.c.io.out.expect().
offset: 569
uri: file://<WORKSPACE>/src/test/scala/passthrough_test_example.scala
text:
```scala
import chisel3._
